...
namespace EasyCmd.Model
{
    ...
    public class BackupJob
    {
        ...
        public BackupJob(string name, string source, string destination, int strategyId, long maxFileSizeInKB)
        {
            Name = name;
            Source = source;
        ...
        /// <summary>
        /// Executes the backup job with file transfer management.
        /// </summary>
        /// <param name="filePaths"></param>
        public void ExecuteBackup(List<string> filePaths)
        {
            foreach (string filePath in filePaths)
            {
                _fileTransferManager.TransferFile(filePath, MaxFileSizeInKB);
            }
        }
    }
}